...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/images/s-logo.svg">
...
<body>
    <div class="content-container">
        ...
        <h2 class="description">SimplePHPLib is a PHP library for front-end and back-end development, which runs 5x faster than Laravel</h2>
    </div>
